...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "WallChange",
    year: "2026",
    description: "Changement de fond d'écran à distance via WebSocket — serveur C, clients identifiés par ID, API HTTP pour envoyer une image à n'importe quel poste.",
    tags: ["C", "C++", "WebSocket", "API HTTP", "Mongoose", "cJSON"],
    details: [
      "Architecture client/serveur en C avec WebSocket (Mongoose).",
      "API HTTP : curl vers le serveur pour envoyer une image à un client ciblé.",
      "Démarrage automatique au boot, gestion multi-clients par ID.",
    ],
    href: "https://github.com/Zeky69/WallChange",
    featured: false,
  },
  {
    slug: "talky",
